  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center w-full max-w-72.5 sm:max-w-120 md:max-w-140 lg:max-w-162.5">
        <span className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-[100px] font-normal tracking-normal">
          Best food for <br className="hidden sm:inline" /> your taste
        </span>
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-foreground leading-6 sm:leading-7 md:leading-8 font-normal mt-6 md:mt-8 mb-8 md:mb-10 lg:px-16.25">
